						...
						<form action="<?php base_url('admin/customer/edit') ?>" method="post" enctype="multipart/form-data">
							...
							<input type="hidden" name="id" value="<?php echo $supplier->supplier_id?>" />
								...
								<input class="form-control <?php echo form_error('supplier_id') ? 'is-invalid':'' ?>"
								 type="number" name="supplier_id" placeholder="Supplier supplier_id" value="<?php echo $supplier->supplier_id ?>" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('supplier_name') ? 'is-invalid':'' ?>"
								 type="text" name="supplier_name" placeholder="Supplier supplier_name" value="<?php echo $supplier->supplier_name ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								<label for="supplier_address">Supplier_Address</label>
								<input class="form-control <?php echo form_error('supplier_address') ? 'is-invalid':'' ?>"
								 type="text" name="supplier_address" placeholder="Supplier supplier_address" value="<?php echo $supplier->supplier_address ?>" />
								<div class="invalid-feedback">
